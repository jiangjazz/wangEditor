...
function Link(editor) {
    this.editor = editor;
    this.$elem = $('<div class="w-e-menu"><i class="w-jzc-icon-link"><i/></div>');
    this.type = 'panel';
...
Enclosure.prototype = {
  ...
  onClick: function onClick(e) {
    // 点击菜单将触发这里
    var editor = this.editor;
    var enclosureClick = editor.enclosureClick || this._clickAction;
    enclosureClick();
  }
};
